    ...
    for item in itertools.product(*request_data):
        ...
        try:
            ...
            if stock_regex == None:
                stock_message = (
                    utc_time_print
                    + ", Stock check: False, Cart check: False, Model: "
                    + artisan_mousepads.mousepad_models(item[0], item[1])
                    + ", Hardness: "
            ...
            # in stock
                ...
                if cart == True:
                    stock_message = (
                        utc_time_print
                        + ", Stock check: True, Cart check: True, Model: "
                        + artisan_mousepads.mousepad_models(item[0], item[1])
                        + ", Hardness: "
                        + artisan_mousepads.mousepad_hardnesses(item[0], item[1])
                        + ", Size: "
                    ...
                    stock_message = (
                        utc_time_print
                        + ", Stock check: True, Cart check: False, Model: "
                        + artisan_mousepads.mousepad_models(item[0], item[1])
                        + ", Hardness: "
                        + artisan_mousepads.mousepad_hardnesses(item[0], item[1])
                        + ", Size: "
            ...
            stock_message = (
                utc_time_print
                + ", Stock check: Request failed, Model: "
                + artisan_mousepads.mousepad_models(item[0], item[1])
                + ", Hardness: "
                + artisan_mousepads.mousepad_hardnesses(item[0], item[1])
                + ", Size: "
